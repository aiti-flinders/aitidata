...
write_metadata <- function() {
 ...
 dates <- purrr::map_dfr(.x = included_data$Item, .f = ~safe_max(.x))
 
 dplyr::bind_cols(included_data, dates) %>%
   dplyr::mutate(Item = str_remove_all(Item, "aitidata::")) %>% 
...
[![Codecov test coverage](https://codecov.io/gh/aiti-flinders/aitidata/branch/master/graph/badge.svg)](https://app.codecov.io/gh/aiti-flinders/aitidata?branch=master)
<!-- badges: end -->
