...
if(!abs_data_up_to_date("6291.0.55.003", data_name = "employment_by_industry") | !file.exists("data/employment_by_industry.rda")) {
  
  message("Updating `data/employment_by_industry.rda`")
  ...
  message("employment by industry already up to date")
}
