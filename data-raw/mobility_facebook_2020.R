## code to prepare `mobility_facebook_2020` dataset goes here
library(readr)
library(dplyr)
library(lubridate)
library(tidyr)
...
mobility_facebook_2020 <- facebook_mobility("2020")
usethis::use_data(mobility_facebook_2020, internal = TRUE, overwrite = TRUE)
