...
if (current_date <= max(aitidata::small_area_labour_market$date)) {
  ...
  all_sa2 <- data.frame(read_absmap("sa22016")) %>%
    dplyr::select(sa2_name_2016, sa2_code_2016, state_name_2016)
